...
* Research & Development of embedded systems for medical support applications
    * Objectively investigate current technologies & market trends
    * Develop prototypes for next generation technology
        * Document experimentation
        * Program prototype software and firmware in C/C++ and Python
        * Perform data analysis with Python
        * Simulate and analyze circuitry in LTSpice
